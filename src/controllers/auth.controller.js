import { emailVerificationService, forgotPasswordService, loginService, profileService, recreateAccountService, registerService, resendVerificationEmailService, resetPasswordService } from "../services/auth.service.js"
...
export const recreateAccountController = async (req, res) => {
    ...
    try {
        ...
        await recreateAccountService(userId)
