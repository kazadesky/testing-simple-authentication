    ...
    <div class="max-w-md w-full space-y-8 text-center">
      ...
      <div class="mt-8">
        <button
          ...
          class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-discrete duration-300 active::scale-95 hover:ring-2 hover:ring-indigo-400 hover:ring-offset-1 focus:md:bg-indigo-700 focus:md:ring-2 focus:md:ring-indigo-400 focus:md:ring-offset-1 cursor-pointer"
        >
